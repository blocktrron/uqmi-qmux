...
#define __uqmi_wda_commands \
	...
	__uqmi_command(wda_data_aggregation_protocol, aggregation-protocol, required, CMD_TYPE_OPTION), \
...
#define wda_helptext \
		...
		"    --aggregation-protocol <proto>: Set aggregation protocol (proto: tlp|qc-cm|mbim|rndis|qmap)\n" \
